...
.SYNOPSIS
    ...
    Used: https://gist.github.com/AzimsTech/b31fa22fd7305a660dea5e54a2bd3e9e & https://stackoverflow.com/questions/25709398/set-location-of-special-folders-with-powershell/26563346#26563346
.PARAMETER Folder
...
'@
	...
	if(!(Test-Path $Path -PathType Container)) {
        # Force output to $null, see https://stackoverflow.com/questions/5260125/whats-the-better-cleaner-way-to-ignore-output-in-powershell
		New-Item -Path $Path -type Directory -Force > $null
    }
    ...
    if (Test-Path $Path -PathType Container) {
        ...
        # Give the folder its fancy icon back
        attrib +r $Path
    } else {
